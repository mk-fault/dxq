...
void GUI_ClearRect        (int x0, int y0, int x1, int y1);//区域清屏x0y0指矩形左上角
//void GUI_DrawArc          (int x0, int y0, int rx, int ry, int a0, int a1);
void GUI_DrawBitmap       (const GUI_BITMAP GUI_UNI_PTR * pBM, int x0, int y0);//显示图片
void GUI_DrawCircle       (int x0, int y0, int r);//画圆
void GUI_DrawEllipse      (int x0, int y0, int rx, int ry);
void GUI_DrawHLine        (int y0, int x0, int x1);//水平线
void GUI_DrawLine         (int x0, int y0, int x1, int y1);//垂直线
//void GUI_DrawLineTo       (int x, int y);
//void GUI_DrawPie          (int x0, int y0, int r, int a0, int a1, int Type);//打点
...
void  GUI_DispStringAt       (const char GUI_UNI_PTR *s, int x, int y);//显示文字
//void  GUI_DispStringAtCEOL   (const char GUI_UNI_PTR *s, int x, int y);
void  GUI_DispStringHCenterAt(const char GUI_UNI_PTR *s, int x, int y);//居中显示
void  GUI__DispStringInRect  (const char GUI_UNI_PTR *s, GUI_RECT* pRect, int TextAlign, int MaxNumChars);//矩形框内显示文字
...
const GUI_FONT GUI_UNI_PTR * GUI_SetFont(const GUI_FONT GUI_UNI_PTR * pNewFont);//设置字体
